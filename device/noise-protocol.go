...
import (
	...
	"github.com/syntlabs/cyanide-go/tai64n"
)
...
const (
	...
	CNIdentifier      = "Cyanide v1 zx2c4 Jason@zx2c4.com"
	CNLabelMAC1       = "mac1----"
	CNLabelCookie     = "cookie--"
)
...
func init() {
	...
	mixHash(&InitialHash, &InitialChainKey, []byte(CNIdentifier))
}
